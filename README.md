...
The current public release is **CURATOR v1.0.0-beta.5**.
...
CURATOR is currently available as **v1.0.0-beta.5**.
...
[authoritative GitHub Release](https://github.com/Jiraiya1969/myOrganizer-CURATOR/releases/tag/v1.0.0-beta.5).
